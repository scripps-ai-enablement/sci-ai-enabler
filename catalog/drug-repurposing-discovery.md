...
- **BioRender Connector** (added 2026-05-19) — Cross-cutting scientific-illustration MCP / Claude.ai connector for target and MoA figures. ([Anthropic tutorial](https://claude.com/resources/tutorials/using-the-biorender-connector-in-claude))
- **10x Genomics Cloud MCP** (added 2026-05-19) — Conversational interface to 10x Cloud single-cell target ID and spatial pharmacology runs. ([10x docs](https://www.10xgenomics.com/support/software/cloud-analysis/latest/tutorials/cloud-mcp-server-code))
