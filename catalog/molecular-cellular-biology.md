...
> Installable Claude components (Skills, MCP servers, Plugins, Connectors) for genomics, transcriptomics, single-cell analysis, gene regulation, CRISPR design, cell imaging, and other molecular- and cell-scale biology applications.
...
- **BioRender Connector** (added 2026-05-19) — Cross-cutting scientific-illustration MCP / Claude.ai connector for cell-biology figures. ([Anthropic tutorial](https://claude.com/resources/tutorials/using-the-biorender-connector-in-claude))
