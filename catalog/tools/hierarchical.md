---
title: Hierarchical Parcellation (Claude Skill)
parent: All tools
...
summary: "Perform brain parcellation using Hierarchical clustering."
---

# Hierarchical Parcellation (Claude Skill)

Perform brain parcellation using Hierarchical clustering.
...
- **Claude Code** — clone and copy the skill into your skills directory:
  ...
  cp -r NeuroClaw/skills/hierarchical ~/.claude/skills/
  ```
...
**Primary use cases**: Perform brain parcellation using Hierarchical clustering.

## Notes

Distributed as a `SKILL.md` (plus code examples) in the NeuroClaw skill library — Claude executes it locally via Bash/Python rather than as an MCP server. Upstream license: MIT. The skill directory upstream is `skills/hierarchical`.

## Sources

- [`CUHK-AIM-Group/NeuroClaw`](https://github.com/CUHK-AIM-Group/NeuroClaw)
- [`skills/hierarchical/SKILL.md`](https://github.com/CUHK-AIM-Group/NeuroClaw/blob/main/skills/hierarchical/SKILL.md)

---

## Installed this tool?

[Share feedback](https://github.com/scripps-ai-enablement/sci-ai-enabler/issues/new?template=tool-feedback.yml&tool=hierarchical&details=Filed+from+https%3A%2F%2Fscripps-ai-enablement.github.io%2Fsci-ai-enabler%2Fcatalog%2Ftools%2Fhierarchical.html%0A%0A) — install path, OS, errors, workarounds. The form opens with this tool pre-selected and a link back to this page.
