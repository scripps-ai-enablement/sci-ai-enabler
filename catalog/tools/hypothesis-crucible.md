...
security_note: "first-party this repo, crucible plugin dir with .claude-plugin/plugin.json (name crucible) + skills/forge/SKILL.md confirmed, registered in marketplace.json"
