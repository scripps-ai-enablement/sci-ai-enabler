---
title: GLM (Task-fMRI) (Claude Skill)
parent: All tools
...
summary: "Run a classical General Linear Model (GLM) for task-evoked fMRI activation analysis."
verification: works
...
- [`skills/glm/SKILL.md`](https://github.com/CUHK-AIM-Group/NeuroClaw/blob/main/skills/glm/SKILL.md)

---

## Installed this tool?

[Share feedback](https://github.com/scripps-ai-enablement/sci-ai-enabler/issues/new?template=tool-feedback.yml&tool=glm&details=Filed+from+https%3A%2F%2Fscripps-ai-enablement.github.io%2Fsci-ai-enabler%2Fcatalog%2Ftools%2Fglm.html%0A%0A) — install path, OS, errors, workarounds. The form opens with this tool pre-selected and a link back to this page.
