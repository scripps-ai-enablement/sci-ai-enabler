...
verification_note: "repo and skills/phylogenetics dir resolve on K-Dense-AI/scientific-agent-skills; smoke clone failed on sandbox missing git (environmental, not tool)"
security: caution
