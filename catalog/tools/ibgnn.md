...
summary: "Run IBGNN (Interpretable Brain Graph Neural Network) for fMRI phenotype prediction."
verification: works
verified_on: 2026-07-27
security: cleared
security_on: 2026-07-27
security_note: "provenance matches supplier CUHK-AIM-Group/NeuroClaw, MIT, not archived (pushed 2026-07-26), skills/ibgnn with SKILL.md resolves, no OSV advisories"
---
...
- [`skills/ibgnn/SKILL.md`](https://github.com/CUHK-AIM-Group/NeuroClaw/blob/main/skills/ibgnn/SKILL.md)

---

## Installed this tool?

[Share feedback](https://github.com/scripps-ai-enablement/sci-ai-enabler/issues/new?template=tool-feedback.yml&tool=ibgnn&details=Filed+from+https%3A%2F%2Fscripps-ai-enablement.github.io%2Fsci-ai-enabler%2Fcatalog%2Ftools%2Fibgnn.html%0A%0A) — install path, OS, errors, workarounds. The form opens with this tool pre-selected and a link back to this page.
