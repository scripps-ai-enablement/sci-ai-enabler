...
security_note: "first-party anthropics/healthcare, clinical-note-extract skill dir confirmed via contents API, but repo has no top-level LICENSE despite Free/OSS claim"
