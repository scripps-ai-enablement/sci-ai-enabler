...
verification_note: "GitHub repo QuentinCody/open-neuro-mcp-server and the hosted workers.dev/sse endpoint both return 404 for a fourth consecutive run — no working install path"
flagged: repo `QuentinCody/open-neuro-mcp-server` (GitHub API + web) and the hosted `open-neuro-mcp-server.quentincody.workers.dev/sse` endpoint both 404 across four 2026-07-20 runs — tool appears removed, no fixable path
security: caution
...
| **Verified** | broken · 2026-07-20 — repo and hosted endpoint both 404 for a fourth consecutive run |
...
[Share feedback](https://github.com/scripps-ai-enablement/sci-ai-enabler/issues/new?template=tool-feedback.yml&tool=openneuro&details=Filed+from+https%3A%2F%2Fscripps-ai-enablement.github.io%2Fsci-ai-enabler%2Fcatalog%2Ftools%2Fopenneuro.html%0A%0A) — install path, OS, errors, workarounds. The form opens with this tool pre-selected and a link back to this page.
