...
verification_note: "GitHub repo QuentinCody/open-neuro-mcp-server and the hosted workers.dev/sse endpoint both return 404 for a third consecutive run — no working install path"
flagged: repo `QuentinCody/open-neuro-mcp-server` (GitHub API + web) and the hosted `open-neuro-mcp-server.quentincody.workers.dev/sse` endpoint both 404 across three 2026-07-20 runs — tool appears removed, no fixable path
security: caution
...
| **Verified** | broken · 2026-07-20 — repo and hosted endpoint both 404 for a third consecutive run |
