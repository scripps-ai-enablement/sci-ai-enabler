...
security_note: "provenance matches supplier K-Dense-AI, Apache-2.0 prompt/doc skill with no external calls, maintained (pushed 2026-07-15), no OSV advisories"
...
| **Security** | cleared · 2026-07-20 — provenance matches K-Dense-AI, Apache-2.0 prompt/doc skill, maintained, no OSV advisories |
