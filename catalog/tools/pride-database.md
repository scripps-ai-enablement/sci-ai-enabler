...
security_note: "provenance matches jaechang-hits/SciAgent-Skills, skill code CC BY 4.0, PRIDE data CC BY 4.0, no OSV advisories"
---
...
| **Security** | cleared · 2026-07-20 — provenance matches supplier, skill code CC BY 4.0, PRIDE data CC BY 4.0, no OSV advisories |
...
- **Manual / other agents** — point the agent at the skill file directly:
  ```
  cp -r SciAgent-Skills/skills/proteomics-protein-engineering/pride-database ~/.claude/skills/
  ```
...
- [`skills/proteomics-protein-engineering/pride-database/SKILL.md`](https://github.com/jaechang-hits/SciAgent-Skills/blob/main/skills/proteomics-protein-engineering/pride-database/SKILL.md)

---

## Installed this tool?

[Share feedback](https://github.com/scripps-ai-enablement/sci-ai-enabler/issues/new?template=tool-feedback.yml&tool=pride-database&details=Filed+from+https%3A%2F%2Fscripps-ai-enablement.github.io%2Fsci-ai-enabler%2Fcatalog%2Ftools%2Fpride-database.html%0A%0A) — install path, OS, errors, workarounds. The form opens with this tool pre-selected and a link back to this page.
