...
| **Security** | cleared · 2026-07-27 — Anthropic plugin path resolves, allotropy dep is Benchling OSS MIT, no OSV advisories |
...
[Share feedback](https://github.com/scripps-ai-enablement/sci-ai-enabler/issues/new?template=tool-feedback.yml&tool=instrument-data-to-allotrope&details=Filed+from+https%3A%2F%2Fscripps-ai-enablement.github.io%2Fsci-ai-enabler%2Fcatalog%2Ftools%2Finstrument-data-to-allotrope.html%0A%0A) — install path, OS, errors, workarounds. The form opens with this tool pre-selected and a link back to this page.
