...
summary: "Run FM-APP for phenotype prediction using fMRI ROI features and optional sMRI features."
verification: works
...
Run FM-APP for phenotype prediction using fMRI ROI features and optional sMRI features.
...
- **Claude Code** — clone and copy the skill into your skills directory:
  ...
  cp -r NeuroClaw/skills/fm_app ~/.claude/skills/
  ```
...
**Primary use cases**: Run FM-APP for phenotype prediction using fMRI ROI features and optional sMRI features.

## Notes

Distributed as a `SKILL.md` (plus code examples) in the NeuroClaw skill library — Claude executes it locally via Bash/Python rather than as an MCP server. Upstream license: MIT. The skill directory upstream is `skills/fm_app`.

## Sources

- [`CUHK-AIM-Group/NeuroClaw`](https://github.com/CUHK-AIM-Group/NeuroClaw)
- [`skills/fm_app/SKILL.md`](https://github.com/CUHK-AIM-Group/NeuroClaw/blob/main/skills/fm_app/SKILL.md)

---

## Installed this tool?

[Share feedback](https://github.com/scripps-ai-enablement/sci-ai-enabler/issues/new?template=tool-feedback.yml&tool=fm_app&details=Filed+from+https%3A%2F%2Fscripps-ai-enablement.github.io%2Fsci-ai-enabler%2Fcatalog%2Ftools%2Ffm_app.html%0A%0A) — install path, OS, errors, workarounds. The form opens with this tool pre-selected and a link back to this page.
