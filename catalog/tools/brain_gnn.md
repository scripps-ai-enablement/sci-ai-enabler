...
summary: "Run BrainGNN for fMRI phenotype prediction, including graph construction, training, and evaluation."
---
...
- [`skills/brain_gnn/SKILL.md`](https://github.com/CUHK-AIM-Group/NeuroClaw/blob/main/skills/brain_gnn/SKILL.md)

---

## Installed this tool?

[Share feedback](https://github.com/scripps-ai-enablement/sci-ai-enabler/issues/new?template=tool-feedback.yml&tool=brain_gnn&details=Filed+from+https%3A%2F%2Fscripps-ai-enablement.github.io%2Fsci-ai-enabler%2Fcatalog%2Ftools%2Fbrain_gnn.html%0A%0A) — install path, OS, errors, workarounds. The form opens with this tool pre-selected and a link back to this page.
