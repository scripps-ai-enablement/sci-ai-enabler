...
verification_note: "repo and skills/rdkit dir resolve on K-Dense-AI/scientific-agent-skills; smoke run this cycle installed the K-Dense collection via npx skills add (pass)"
security: cleared
