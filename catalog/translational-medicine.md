...
> Installable Claude components (Skills, MCP servers, Plugins, Connectors) bridging discovery and clinical application — clinical-trial tooling, biomarker discovery, patient stratification, real-world evidence, EHR-aware agents, and regulatory-document assistants.
...
- **BioRender Connector** (added 2026-05-19) — Scientific-illustration MCP / Claude.ai connector for clinical and translational figures. ([Anthropic tutorial](https://claude.com/resources/tutorials/using-the-biorender-connector-in-claude))
- **10x Genomics Cloud MCP** (added 2026-05-19) — Conversational interface to 10x Cloud single-cell biomarker discovery and spatial pathology runs. ([10x docs](https://www.10xgenomics.com/support/software/cloud-analysis/latest/tutorials/cloud-mcp-server-code))
