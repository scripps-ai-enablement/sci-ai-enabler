...
A curated catalog of AI ecosystem components for life-science applications — MCP servers, plugins, skills, agents, workflows, hosted services, and libraries.
...
Each entry includes type, supplier, availability, pricing, capabilities, primary use cases, benchmarks, installation, integration notes, sources, and verification timestamps. See [`AGENT.md`](../AGENT.md) for the canonical schema.
