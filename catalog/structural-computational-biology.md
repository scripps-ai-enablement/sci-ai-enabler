...
> Installable Claude components (Skills, MCP servers, Plugins, Connectors) for protein and complex structure prediction, molecular dynamics, integrative modeling, cryo-EM analysis, and computational biology workflows that span structure, sequence, and dynamics.
...
- **BioRender Connector** (added 2026-05-19) — Cross-cutting scientific-illustration MCP / Claude.ai connector for pathway and structure figures. ([Anthropic tutorial](https://claude.com/resources/tutorials/using-the-biorender-connector-in-claude))
- **10x Genomics Cloud MCP** (added 2026-05-19) — Conversational interface to 10x Cloud single-cell / Visium / Xenium analyses. ([10x docs](https://www.10xgenomics.com/support/software/cloud-analysis/latest/tutorials/cloud-mcp-server-code))
- **single-cell-rna-qc** (added 2026-05-19) — Anthropic's first scientific skill — scverse MAD-based QC for `.h5ad` and 10x `.h5` inputs. ([SKILL.md](https://github.com/anthropics/life-sciences/blob/main/single-cell-rna-qc/SKILL.md))
