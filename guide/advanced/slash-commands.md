...
- [Claude Code changelog (v2.1.152–v2.1.198)](https://code.claude.com/docs/en/changelog) — `disallowed-tools` frontmatter on slash commands and skills (v2.1.152); subagents can spawn subagents up to 5 levels deep (v2.1.172, 2026-06-09); subagents run in background by default and inherit session extended-thinking config (v2.1.198, 2026-07-01); verified 2026-07-04 (this run).
