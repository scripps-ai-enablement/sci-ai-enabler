...
- [Claude Code product landing](https://claude.com/product/claude-code) and [Claude Code changelog](https://code.claude.com/docs/en/changelog) — re-verified 2026-08-01 (this run); install command and launch surfaces unchanged; latest release still v2.1.220 (2026-07-25), no beginner-relevant changes since.
