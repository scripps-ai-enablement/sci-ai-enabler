...
- Pick a model with `/model` (or `--model` at launch). **Claude Sonnet 5 is the default** as of v2.1.197 (2026-06-30) — a cheaper, more-agentic Sonnet with a native 1M-token context window; Opus 4.8 remains selectable for the hardest jobs. **Claude Fable 5** is available again: after a 19-day suspension it was redeployed globally on 2026-07-01 once the U.S. government lifted its export-control order, so it appears in the picker for all users. (Mythos 5 is restricted to approved U.S. organizations.)
...
- [Claude Code changelog (v2.1.196–v2.1.214)](https://code.claude.com/docs/en/changelog) — Anthropic docs; verified 2026-07-18 (this run) — Sonnet 5 default (v2.1.197, 2026-06-30); Claude in Chrome GA + subagents background-by-default + `/dataviz` skill + background agents auto-open draft PRs (v2.1.198, 2026-07-01); permission dialogs require manual approval by default (v2.1.200, 2026-07-03); screen-reader mode `--ax-screen-reader` (v2.1.208, 2026-07-14); `/fork` now copies the conversation into a background session and the in-session subagent launcher becomes `/subtask`, per-session subagent + WebSearch caps, MCP calls auto-background after 2 min (v2.1.212, 2026-07-17); EndConversation tool (v2.1.214, 2026-07-18). Latest release v2.1.214 (2026-07-18).
