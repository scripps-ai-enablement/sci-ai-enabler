...
- [Claude Code changelog (v2.1.196–v2.1.201)](https://code.claude.com/docs/en/changelog) — Anthropic docs; verified 2026-07-04 (this run) — Sonnet 5 default (v2.1.197, 2026-06-30); Claude in Chrome GA + subagents background-by-default + `/dataviz` skill + background agents auto-open draft PRs (v2.1.198, 2026-07-01); permission dialogs require manual approval by default (v2.1.200, 2026-07-03).
