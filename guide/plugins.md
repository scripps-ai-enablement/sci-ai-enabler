...
- [Claude Code changelog (May–June 2026)](https://code.claude.com/docs/en/changelog) — `--plugin-dir` zip support, `--plugin-url`, dependency enforcement, `claude plugin prune`, `/plugin` Discover/Browse component previews, (v2.1.157, 2026-05-29) auto-loading of plugins in `.claude/skills/` plus `claude plugin init <name>` scaffolding, and (v2.1.163, 2026-06-04) `/plugin list --enabled` / `--disabled` filters; verified 2026-06-06 (this run).
