...
- [Channels reference](https://code.claude.com/docs/en/channels-reference) — Anthropic docs; verified 2026-06-03 (this run) — `--channels`, bundled plugins, `claude.ai` OAuth-only auth, Team / Enterprise `channelsEnabled` + `allowedChannelPlugins` managed settings, `--dangerously-load-development-channels`.
