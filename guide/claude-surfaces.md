...
- [Assign tasks from anywhere in Claude Cowork](https://support.claude.com/en/articles/13947068-assign-tasks-from-anywhere-in-claude-cowork) — Anthropic help center; verified 2026-08-01 (this run) — Dispatch QR-code pairing, desktop-must-stay-awake requirement, distinction from cloud-run sessions.
